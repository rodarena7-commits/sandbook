...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 font-sans text-slate-900 overflow-x-hidden selection:bg-indigo-100">
      ...
      {/* MODAL DETALLE DE LIBRO (PORTADA) CON BOTÓN DE RECOMENDAR */}
      {viewingBook && (
               ...
               <div className="space-y-6 animate-in fade-in">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                     {publicData
                       ...
                       .map(p => (
                        <div key={p.userId} onClick={() => setSelectedUserProfile(p)} className="bg-white p-4 rounded-[2.5rem] border border-slate-100 shadow-sm flex items-center justify-between animate-in zoom-in-95 group cursor-pointer hover:border-indigo-200">
                           <div className="flex items-center gap-3">
                           ...
                           <div className="flex items-center gap-2">
                              <button onClick={(e) => {e.stopPropagation(); updateDoc(doc(db, 'profiles', user.uid), { dismissedUsers: arrayUnion(p.userId) });}} className="p-3 text-slate-200 hover:text-red-400 transition-colors"><UserX size={18}/></button>
