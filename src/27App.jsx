            ...
            <div className="flex-shrink-0 px-6 pb-4">
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center gap-4 mt-3">
                  <div className="text-center">
                    <p className="font-black text-lg">{getReadersCount(bookDetailData.bookId || bookDetailData.id)}</p>
                    <p className="text-[10px] text-slate-400 uppercase">{t.readers_count}</p>
                  </div>
                  <div className="text-center">
                    <p className="font-black text-lg">{globalLikes[bookDetailData.bookId || bookDetailData.id]?.likes?.length || 0}</p>
                    <p className="text-[10px] text-slate-400 uppercase">{t.like}</p>
                  </div>
                  <div className="text-center">
                    <p className="font-black text-lg">{globalLikes[bookDetailData.bookId || bookDetailData.id]?.dislikes?.length || 0}</p>
